...
parser.add_argument("--result_dir", default="./prediction/prediction.npy",help="path to save the results")
...
if __name__ == '__main__':
	...
	if args.mode == 'train':
		...
		x_train_v, y_train_v, x_valid, y_valid = train_valid_split(x_train, y_train)

		model.train(x_train_v, y_train_v, training_configs, x_valid, y_valid)
